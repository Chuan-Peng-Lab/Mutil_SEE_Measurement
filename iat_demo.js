...
var IAT_instr1 = {
    ...
    —— 任务1：对“${iat.targetA.label}”词和“${iat.targetB.label}”词分类 ——<br/>
...
var IAT_instr2 = {
    ...
    stimulus: `
    <div class="tag-bottom"><p>
    —— 任务2：对“${iat.attribA.label}”词和“${iat.attribB.label}”词分类 ——<br/>   
...
var IAT_instr3 = {
    ...
    stimulus: `
    <div class="tag-bottom"><p>
    —— 任务3：对“${iat.targetA.label}/${iat.attribA.label}”词和“${iat.targetB.label}/${iat.attribB.label}”词分类 ——<br/>
...
var IAT_instr4 = {
    ...
    stimulus: `
    <div class="tag-bottom"><p>
    —— 任务4：对“${iat.targetA.label}/${iat.attribA.label}”词和“${iat.targetB.label}/${iat.attribB.label}”词分类 ——<br/>
...
var IAT_instr6 = {
    ...
    stimulus: `
    <div class="tag-bottom"><p>
    —— 任务6：对“${iat.targetA.label}/${iat.attribB.label}”词和“${iat.targetB.label}/${iat.attribA.label}”词分类 ——<br/>
...
var IAT_instr7 = {
    ...
    stimulus: `
    <div class="tag-bottom"><p>
    —— 任务7：对“${iat.targetA.label}/${iat.attribB.label}”词和“${iat.targetB.label}/${iat.attribA.label}”词分类 ——<br/>
...
var IAT_instr01 = {
    ...
    stimulus: `
    <div class="tag-bottom"><p>
    —— 任务1：对“${iat2.targetA.label}”词和“${iat2.targetB.label}”词分类 ——<br/>
    不同词语会出现在屏幕中央，类别标签将始终显示在屏幕上方<br/>   
    <span style="color:#FFD866"><b>请根据上方标签的提示，尽可能正确并且快速地做出按键反应</b></span><br/>
    当按键错误时屏幕中会出现<span style="color:red"> X </span>，需要按另一个键纠正才能继续<br/><br/>
    请把双手食指分别放在键盘的“${key_L.toUpperCase()}”键和“${key_R.toUpperCase()}”键上<br/>
...
var IAT_instr02 = {
    ...
    stimulus: `
    <div class="tag-bottom"><p>
    —— 任务2：对“${iat2.attribC.label}”词和“${iat2.attribD.label}”词分类 ——<br/>   
    <span style="color:#78DCE8"><b>注意上方，类别标签和需要分类的词语都已经改变</b></span><br/>
    <span style="color:#FFD866"><b>请根据上方标签的提示，尽可能正确并且快速地做出按键反应</b></span><br/>
    当按键错误时屏幕中会出现<span style="color:red"> X </span>，需要按另一个键纠正才能继续<br/><br/>
    请把双手食指分别放在键盘的“${key_L.toUpperCase()}”键和“${key_R.toUpperCase()}”键上<br/>
...
var IAT_instr03 = {
    ...
    stimulus: `
    <div class="tag-bottom"><p>
    —— 任务3：对“${iat2.targetA.label}/${iat2.attribC.label}”词和“${iat2.targetB.label}/${iat2.attribD.label}”词分类 ——<br/>
    <span style="color:#78DCE8"><b>注意上方，之前的四类词语将混合在一起交替呈现</b></span><br/>
    <span style="color:#FFD866"><b>请根据上方标签的提示，尽可能正确并且快速地做出按键反应</b></span><br/>
    当按键错误时屏幕中会出现<span style="color:red"> X </span>，需要按另一个键纠正才能继续<br/><br/>
    请把双手食指分别放在键盘的“${key_L.toUpperCase()}”键和“${key_R.toUpperCase()}”键上<br/>
...
var IAT_instr04 = {
    ...
    stimulus: `
    <div class="tag-bottom"><p>
    —— 任务4：对“${iat2.targetA.label}/${iat2.attribC.label}”词和“${iat2.targetB.label}/${iat2.attribD.label}”词分类 ——<br/>
    <span style="color:#78DCE8"><b>与刚才的任务完全相同，请再次对这四类词语分类</b></span><br/>
    <span style="color:#FFD866"><b>请根据上方标签的提示，尽可能正确并且快速地做出按键反应</b></span><br/>
    当按键错误时屏幕中会出现<span style="color:red"> X </span>，需要按另一个键纠正才能继续<br/><br/>
    请把双手食指分别放在键盘的“${key_L.toUpperCase()}”键和“${key_R.toUpperCase()}”键上<br/>
...
var IAT_instr05 = {
    ...
    stimulus: `
    <div class="tag-bottom"><p>
    —— 任务5：对“${iat2.targetB.label}”词和“${iat2.targetA.label}”词分类 ——<br/>
    <span style="color:#FF6188"><b>注意上方，仍然是两个类别标签，但互换了位置！</b></span><br/>
    <span style="color:#FFD866"><b>请根据上方标签的提示，尽可能正确并且快速地做出按键反应</b></span><br/>
    当按键错误时屏幕中会出现<span style="color:red"> X </span>，需要按另一个键纠正才能继续<br/><br/>
    请把双手食指分别放在键盘的“${key_L.toUpperCase()}”键和“${key_R.toUpperCase()}”键上<br/>
...
var IAT_instr06 = {
    ...
    stimulus: `
    <div class="tag-bottom"><p>
    —— 任务6：对“${iat2.targetA.label}/${iat2.attribD.label}”词和“${iat2.targetB.label}/${iat2.attribC.label}”词分类 ——<br/>
    <span style="color:#FF6188"><b>注意上方，四类词语将以新的组合方式交替呈现！</b></span><br/>
    <span style="color:#FFD866"><b>请根据上方标签的提示，尽可能正确并且快速地做出按键反应</b></span><br/>
    当按键错误时屏幕中会出现<span style="color:red"> X </span>，需要按另一个键纠正才能继续<br/><br/>
    请把双手食指分别放在键盘的“${key_L.toUpperCase()}”键和“${key_R.toUpperCase()}”键上<br/>
...
var IAT_instr07 = {
    ...
    stimulus: `
    <div class="tag-bottom"><p>
    —— 任务7：对“${iat2.targetA.label}/${iat2.attribD.label}”词和“${iat2.targetB.label}/${iat2.attribC.label}”词分类 ——<br/>
    <span style="color:#FF6188"><b>与刚才的任务完全相同，请再次对这四类词语分类</b></span><br/>
    <span style="color:#FFD866"><b>请根据上方标签的提示，尽可能正确并且快速地做出按键反应</b></span><br/>
    当按键错误时屏幕中会出现<span style="color:red"> X </span>，需要按另一个键纠正才能继续<br/><br/>
    请把双手食指分别放在键盘的“${key_L.toUpperCase()}”键和“${key_R.toUpperCase()}”键上<br/>
