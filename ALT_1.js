...
var words1 = ["圆形","菱形", "方形", "三角",]
var words2 = ["椭圆","六边","五边","梯形",]//储存文字
...
var welcome = {
  ...
  stimulus: `
   <p><div style = "color: white">您好，欢迎参加本次实验。</div> </p>
   <p><div style = "color: white">为充分保障您的权利，请确保您已经知晓并同意《参与实验同意书》以及《数据公开知情同意书》。</div></p>
   <p><div style = "color: white">如果您未见过上述内容，请咨询实验员。</div></p>
   <p><div style = "color: white">如果您选择继续实验，则表示您已经清楚两份知情同意书的内容并同意。</div></p>
...
=======
    var subj_idx = response["subj_idx"].trim();
    var friend_name= response["friend_name"].trim();
>>>>>>> dfbbc3667928ca1b56c41c432790d26c45ed9405
    ...
    jsPsych.randomization.shuffle(images1).forEach((v, i) => { //将image随机
      view_texts_images.push(`<img src="${v}" width=150 style="vertical-align:middle">---${words1[images1.indexOf(v)]}`); //image编号和文字对应
      ...
      jsPsych.randomization.shuffle(images2).forEach((v, i) => { //将image随机
        view_texts_images2.push(`<img src="${v}" width=150 style="vertical-align:middle">---${words2[images2.indexOf(v)]}`); //image编号和文字对应
        console.log(view_texts_images2); } );
...
var Instructions0 = {
  ...
  pages: function () {
    let start = "<p class='header' style = 'color:red;font-size: 35px'>实验说明:</p>";   
    return [start +` <p style='color:white; font-size: 25px;line-height: 30px;'>您好，欢迎参加本实验。</p><p style='color:white; font-size: 25px;'>在本实验中，您需要完成一个简单的知觉匹配任务。</p><p style='color:white; font-size: 25px;'>您将学习几种几何图形与不同标签的对应关系。</p>
   <p class='footer' style='color:yellow;font-size: 30px; line-height: 35px;'>您的任务是判断几何图形与图形名称是否匹配，</p><p style='color:white; font-size: 25px; line-height: 30px;'>您将完成2个相似的知觉匹配的子任务</p><p style='color:white; font-size: 25px; line-height: 30px;'>整个知觉匹配任务将持续大约50分钟。</p><p style = 'font-size: 25px; line-height: 30px;'>请点击 继续 进入实验<span style='color: yellow;'>开始任务一</span>的练习</span></p><div>`];
  },
  ...
  var Instructions1 = {
    ...
    pages: function () {
      ...
      return [
        ...
        `<p class='footer' style='color: lightgreen;font-size: 30px; line-height: 35px;'>您的任务是判断几何图形与图形名称是否匹配，</p><p class='footer' style='color:white; font-size: 25px;'>如果二者<span style="color: lightgreen; font-size:25px">匹配</span>，请按<span style="color: lightgreen; font-size:25px"> ${key[0]}键</span></p><p class='footer' style='color:white; font-size: 25px;'>如果二者<span style="color: red; font-size:25px">不匹配</span>，请按<span style="color: red; font-size:25px"> ${key[1]}键</span></p><p class='footer' style='color:white; font-size: 20px;'>请在实验过程中将您的<span style="color: lightgreen;">食指</span>放在电脑键盘的相应键位上准备按键。</p></span>`,
...
//----------------------------练习--------------------
  ...
  var prac_s = {
    ...
    on_finish: function(data){
        ...
        var index_w = words.indexOf(data.word);
        var conditionType = tag[index_i] + '_'+words[index_w];       
        data.Image_word = conditionType;
        data.condition = "prac_ALT11";
...
var Instructions2 = {
  ...
  pages: function () {
    ...
    return [
      start + `<div class="box">${tmpI}</div>` +
        `<p class='footer' style='color: lightgreen;font-size: 30px; line-height: 35px;'>您的任务是判断几何图形与图形名称是否匹配，</p><p class='footer' style='color:white; font-size: 25px;'>如果<span style="color: lightgreen; font-size:25px">匹配</span>，请按<span style="color: lightgreen; font-size:25px"> ${key[0]}键</span></p><p class='footer' style='color:white; font-size: 25px;'>如果二者<span style="color: red; font-size:25px">不匹配</span>，请按<span style="color: red; font-size:25px"> ${key[1]}键</span></p><p class='footer' style='color:white; font-size: 20px;'>请在实验过程中将您的<span style="color: lightgreen;">食指</span>放在电脑键盘的相应键位上准备按键。</p></span>`,
        `<p style='color:white; font-size: 25px; line-height: 30px;'>您将首先完成1组练习，以确保您理解了任务要求。<span style="color: yellow; "></p><p>之后您将完成8组正式任务,</span></p><p>每组包括48次按键的匹配任务。</p><p style='color:white; font-size: 25px; line-height: 30px;'>每组完成后会有休息时间。</p><p style='color:white; font-size: 22px; line-height: 25px;'>完成一组任务大约需要2分钟，整个子任务将持续大约25分钟。</p>`,//实验时间待修改
        "<p class='footer'  style = 'font-size: 25px'>如果对本实验还有不清楚之处，请立即向实验员咨询。</p><p style = 'font-size: 25px; line-height: 30px;'>如果您明白了规则：请点击 继续 进入练习</p>"];
  },
  show_clickable_nav: true,
...
var feedback_continue_practice2 = { //在这里呈现文字recap，让被试再记一下
  ...
  pages: function () {
    ...
    return ["<p class='header' style='font-size:25px; line-height:30px;'>您的正确率未达到进入下一阶段练习的要求。</p>",
      ...
      `<p class='footer' style='color: lightgreen;font-size:25px; line-height:30px;'>您的任务是判断几何图形与图形名称是否匹配，</p><p class='footer' style='font-size:25px; line-height:30px;'>如果<span style="color: lightgreen; font-size:25px">匹配</span>，请按 <span style="color: lightgreen;"> ${key[0]} 键</span></p><p class='footer' style='font-size:25px'>如果二者<span style="color:red; font-size:25px">不匹配</span>，请按<span style="color: red;"> ${key[1]} 键</span></p><p class='footer' style='font-size:22px; line-height:25px;'>请在实验过程中将您的<span style="color: lightgreen;">食指</span>放在电脑键盘的相应键位上进行按键。</p></span>`,
      middle + end];
  },
  show_clickable_nav: true,
  button_label_previous: " <span class='add_' style='color:black; font-size: 20px;'> 返回</span>",
