/*const jsPsych = initJsPsych({
  ...
  const images1 = ['img/circle.png', 'img/diamond.png','img/square.png','img/triangle.png']//设置刺激
  const images2 = ['img/ellipse.png', 'img/hexagon.png','img/pentagon.png','img/trapezoid.png',]
...
const tag1 = ["圆形","菱形", "方形", "三角"]
const tag2 = ["椭圆","六边","五边","梯形"]
var tag = tag1.concat(tag2)
...
var welcome = {
  ...
  stimulus: `
   <p style='color:white; font-size: 25px;line-height: 30px;'>您好，欢迎参加本次实验。</p>
   <p style='color:white; font-size: 25px;line-height: 30px;'>为充分保障您的权利，请确保您已经知晓并同意《参与实验同意书》以及《数据公开知情同意书》。</p>
   <p style='color:white; font-size: 25px;line-height: 30px;'>如果您未见过上述内容，请咨询实验员。</p>
   <p style='color:white; font-size: 25px;line-height: 30px;'>如果您选择继续实验，则表示您已经清楚两份知情同意书的内容并同意。</p>
    ...
    on_finish: function (data) {  
     ...
     //将response[{"name":"Sex","value":"1"},{"name":"subj_idx","value":"34"}]内value提取，并储存至info
      ...
      if (info["Sex"] === "Female") {//根据被试性别，选择不同的文字标签（e.g.好她)
        ...
        texts = word[parseInt(info["subj_idx"]) % 24];//从24种排列组合中选择一种标签顺序，与image1对应，构成规则
        jsPsych.randomization.shuffle(images1).forEach(function (v, i) {//随机该规则中4种刺激的呈现顺序
          view_texts_images.push(`<img src="${v}" width=150 style="vertical-align:middle">---<span style="color:white">${texts[images1.indexOf(v)]}</span>`);
        });
      } else if (info["Sex"] === "Male") {
        texts = moral_m;
        word = permutation(texts, 4);
        texts = word[parseInt(info["subj_idx"]) % 24];
      ...
      if (info["Sex"] === "Female") {
        ...
        texts2 = word2[parseInt(info["subj_idx"]) % 24];
        jsPsych.randomization.shuffle(images2).forEach(function (v, i) {
          view_texts_images2.push(`<img src="${v}" width=150 style="vertical-align:middle">---<span style="color:white">${texts2[images2.indexOf(v)]}</span>`);
        });
      } else if (info["Sex"] === "Male") {
        texts2 = ability_m;
        word2 = permutation(texts2, 4);
      ...
      info["Word"] =texts;
      info["view_texts_images"] = view_texts_images;
      info["Word2"] = texts2;
      info["view_texts_images2"] = view_texts_images2;

      data.id = info["subj_idx"];
     
      data.t_images=tag1;
      data.t_images2=tag2;
      data.rule1=info["Word"];
      data.rule2=info["Word2"];
      console.log(images1);
      console.log(texts);
      console.log(images2);
      console.log(texts2);
...
var ALT2_Instructions0 = {
  ...
  pages: function () {
    ...
    return [start +` <p style='color:white; font-size: 25px;line-height: 30px;'>您好，欢迎参加本实验。</p>
    <p class='footer' style='color: lightgreen;font-size: 30px; line-height: 35px;'>在本实验中将用“他（她）”指代您刚才回忆起的朋友，并且不同的图形将分别代表自我或朋友身上的不同特性。</p><p style='color:white; font-size: 25px;'>在本实验中，您需要完成一个简单的知觉匹配任务。</p><p style='color:white; font-size: 25px;'>您将学习几种几何图形与不同标签的对应关系。</p>
   <p class='footer' style='color:yellow;font-size: 30px; line-height: 35px;'>您的任务是判断几何图形与文字标签是否匹配，</p><p style='color:white; font-size: 25px; line-height: 30px;'>您将完成2个相似的知觉匹配的子任务</p><p style='color:white; font-size: 25px; line-height: 30px;'>整个知觉匹配任务将持续大约50分钟。</p><p style = 'font-size: 25px; line-height: 30px;'>请点击 继续 进入实验<span style='color: yellow;'>开始任务一</span>的练习</span></p><div>`];
  },
...
//-----------------------------实验指导语--------------------
  ...
  var Instructions1 = {
    ...
    pages: function () {
      ...
      return [`<p class='header' style = 'font-size: 25px'>实验中将出现一些文字标签，标签的意义如下:</p><br> <p class='footer' style='color: white;font-size: 25px; line-height: 25px;'>“好我”代表自己身上道德的方面，您可以想象自己在此刻做了道德的事件。</p>
      ...
      <p class='footer' style='color: white;font-size: 25px; line-height: 25px;'>“坏他（她）”代表朋友身上不道德的方面，您可以想象朋友在此刻做了不道德的事件。</p>`,
        ...
        `<p class='footer' style='color: lightgreen;font-size: 25px; line-height: 25px;'>您的任务是判断几何图形与文字标签是否匹配，</p>
       
        <p class='footer' style='color:white; font-size: 25px;'>如果二者<span style="color: lightgreen; font-size:25px">匹配</span>，请按<span style="color: lightgreen; font-size:25px"> ${key[0]} 键</span></p><p class='footer' style='color:white; font-size: 25px;'>如果二者<span style="color: red; font-size:25px">不匹配</span>，请按<span style="color: red; font-size:25px"> ${key[1]} 键</span></p><p class='footer' style='color:white; font-size: 20px;'>请在实验过程中将您的<span style="color: lightgreen;">食指</span>放在电脑键盘的相应键位上准备按键。</p></span>`,

        `<p style='color:white; font-size: 25px; line-height: 30px;'>您将首先完成1组练习，以确保您理解了任务要求。<span style="color: yellow; "></p><p>之后您将完成8组正式任务,</span></p><p>每组包括48次按键的匹配任务。</p><p style='color:white; font-size: 25px; line-height: 30px;'>每组完成后会有休息时间。</p><p style='color:white; font-size: 22px; line-height: 25px;'>完成一组任务大约需要2分钟，整个子任务将持续大约25分钟。</p>`,//实验时间待修改
          "<p class='footer'  style = 'font-size: 25px'>如果对本实验还有不清楚之处，请立即向实验员咨询。</p><p style = 'font-size: 25px; line-height: 30px;'>如果您明白了规则：请点击 继续 进入练习</p>"];
    },
    show_clickable_nav: true,
    button_label_previous: " <span class='add_' style='color:black; font-size: 20px;'> 返回</span>",
    button_label_next: " <span class='add_' style='color:black; font-size: 20px;'> 继续</span>",
...
//----------------------------练习--------------------
  ...
  var prac_s = {
    ...
    on_finish: function(data){
        ...
        var index_w = texts.indexOf(data.word);
        data.conditionType = texts[index_i] + '_'+texts[index_w];  
        data.condition = "prac_ALT2_moral";
...
var feedback_continue_practice3 = { //在这里呈现文字recap，让被试再记一下
    type: jsPsychInstructions,
    pages: function () {
      let start = "<p class='header' style='color: lightgreen;font-size:25px; line-height:30px;'>请您努力记下如下匹配对应关系，再次进行练习。</p>",
      ...
      return ["<p class='header' style='font-size:25px; line-height:30px;'>您的正确率未达到进入下一阶段练习的要求。</p>",
        start + `<div class="box">${tmpI}</div>` +
        `<p class='footer' style='color: lightgreen;font-size:25px; line-height:30px;'>您的任务是判断几何图形与文字标签是否匹配，</p> <p class='footer' style='font-size:25px; line-height:30px;'>如果二者<span style="color: lightgreen; font-size:25px">匹配</span>，请按 <span style="color: lightgreen;"> ${key[0]} 键</span></p><p class='footer' style='font-size:25px'>如果二者<span style="color: red; font-size:25px">不匹配</span>，请按<span style="color: red;"> ${key[1]} 键</span></p><p class='footer' style='font-size:22px; line-height:25px;'>请在实验过程中将您的<span style="color: lightgreen;">食指</span>放在电脑键盘的相应键位上进行按键。</p></span>`,
        middle + end];
    },
    show_clickable_nav: true,
    button_label_previous: " <span class='add_' style='color:black; font-size: 20px;'> 返回</span>",
  ...
  let same = {
    ...
    }, 
   {
    ...
    },//上一组end时间减去下一组show时间就是空屏的100ms
    {
        ...
        choices: ['f', 'j'],
    response_start_time:1000,//开始作答时间，第二个刺激开始计算
    trial_duration:2200,//结束时间，一共作答时间持续1100ms
    data:function(){return jsPsych.timelineVariable("identify")},
    on_finish: function(data){
        data.correct_response = jsPsych.timelineVariable("identify", true)();
        data.correct = data.correct_response == data.key_press;//0错1对
        ...
        var index_w = texts.indexOf(data.word);
        data.conditionType = texts[index_i] + '_'+texts[index_w];  
        data.condition = "formal_ALT2_moral";
...
var Instructions2 = {
  ...
  pages: function () {
    ...
    return [`<p class='header' style = 'font-size: 25px'>实验中将出现一些文字标签，标签的意义如下:</p><br><p class='footer' style='color: lightgreen;font-size: 25px; line-height: 25px;'>“强我”代表自己身上能力优越的方面，您可以想象自己在此刻做了彰显能力的事件。</p>
    <p class='footer' style='color: lightgreen;font-size: 25px; line-height: 25px;'>“弱我”代表自己身上能力不足的方面，您可以想象自己在此刻做了显示能力不足的事件。</p>
    <p class='footer' style='color: lightgreen;font-size: 25px; line-height: 25px;'>“强他（她）”代表朋友身上能力优越的方面，您可以想象朋友在此刻做了彰显能力的事件。</p>
    <p class='footer' style='color: lightgreen;font-size: 25px; line-height: 25px;'>“弱他（她）”代表朋友身上能力不足的方面，您可以想象朋友在此刻做了显示能力不足的事件。</p>`,
      start + `<div class="box">${tmpI}</div>` +
        `<p class='footer' style='color: lightgreen;font-size: 30px; line-height: 35px;'>您的任务是判断几何图形与文字标签是否匹配，</p> 
        <p class='footer' style='color:white; font-size: 25px;'>如果<span style="color: lightgreen; font-size:25px">匹配</span>，请按<span style="color: lightgreen; font-size:25px"> ${key[0]} 键</span></p><p class='footer' style='color:white; font-size: 25px;'>如果二者<span style="color: red; font-size:25px">不匹配</span>，请按<span style="color: red; font-size:25px"> ${key[1]} 键</span></p><p class='footer' style='color:white; font-size: 20px;'>请在实验过程中将您的<span style="color: lightgreen;">食指</span>放在电脑键盘的相应键位上准备按键。</p></span>`,
        `<p style='color:white; font-size: 25px; line-height: 30px;'>您将首先完成1组练习，以确保您理解了任务要求。<span style="color: yellow; "></p><p>之后您将完成8组正式任务,</span></p><p>每组包括48次按键的匹配任务。</p><p style='color:white; font-size: 25px; line-height: 30px;'>每组完成后会有休息时间。</p><p style='color:white; font-size: 22px; line-height: 25px;'>完成一组任务大约需要2分钟，整个子任务将持续大约25分钟。</p>`,//实验时间待修改
        "<p class='footer'  style = 'font-size: 25px'>如果对本实验还有不清楚之处，请立即向实验员咨询。</p><p style = 'font-size: 25px; line-height: 30px;'>如果您明白了规则：请点击 继续 进入练习</p>"];
  },
  show_clickable_nav: true,
...
var prac_s2 = {
  ...
  on_finish: function(data){
      ...
      var index_w = texts2.indexOf(data.word);
      data.conditionType = texts2[index_i] + '_'+texts2[index_w];  
      data.condition = "prac_ALT2_ability";
...
var feedback_continue_practice2 = { //在这里呈现文字recap，让被试再记一下
  ...
  pages: function () {
    ...
    let tmpI2 = "";
    view_texts_images2.forEach(v => {
      tmpI2 += `<p class="content" style='font-size:25px'>${v}</p>`;
    });
    return ["<p class='header' style='font-size:25px; line-height:30px;'>您的正确率未达到进入下一阶段练习的要求。</p>",
      start + `<div class="box">${tmpI2}</div>` +
      `<p class='footer' style='color: lightgreen;font-size:25px; line-height:30px;'>您的任务是判断几何图形与文字标签是否匹配，</p>
      <p class='footer' style='font-size:25px; line-height:30px;'>如果<span style="color: lightgreen; font-size:25px">匹配</span>，请按 <span style="color: lightgreen;"> ${key[0]} 键</span></p><p class='footer' style='font-size:25px'>如果二者<span style="color:red; font-size:25px">不匹配</span>，请按<span style="color: red;"> ${key[1]} 键</span></p><p class='footer' style='color:white;font-size:22px; line-height:25px;'>请在实验过程中将您的<span style="color: lightgreen;">食指</span>放在电脑键盘的相应键位上进行按键。</p></span>`,
      middle + end];
  },
  show_clickable_nav: true,
  button_label_previous: " <span class='add_' style='color:black; font-size: 20px;'> 返回</span>",
...
let same2 = {
  ...
  }, 
 {
  ...
  on_finish: function(data){
      ...
      var index_w = texts2.indexOf(data.word);
      data.conditionType = texts2[index_i] + '_'+texts2[index_w];
      data.condition = "formal_ALT2_ability";
